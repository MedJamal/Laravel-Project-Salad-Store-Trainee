    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                <div id="logo">
                    <a href="/">
                        <img class="img-responsive" src="{{ asset('images\header1\logo.png') }}" alt="logo" title="logo">
                    </a>
                </div>
            </div>	
                            ...
                            <ul class="nav navbar-nav text-right">
                                <li class="dropdown topheader">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <div class="col-sm-3">
                                            <img src="{{ asset('images\header1\free-shipping.png') }}" class="img-responsive" alt="img" title="img">
                                        </div>
                                    </div>
                                </li>
                                <li>
                                            ...
                                            <ul class="list-unstyled">
                                                <li class="dropdown-submenu">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a href="index-1.html">Header 1</a>
                                                        </li>
                                                        <li>
